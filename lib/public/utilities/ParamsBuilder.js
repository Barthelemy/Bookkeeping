...
export default class ParamsBuilder {
    ...
    /**
     * Validates if there are actually values in the list and otherwise adds the values as a parameter.
     * @param {String} identifier sdfsd
     * @param {Array} list fsdf
     * @returns {undefined}
     */
    addList(identifier, list) {
        if (list.length > 0) {
            this.params[identifier] = list;
        }
    }
