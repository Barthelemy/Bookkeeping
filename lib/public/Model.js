...
import Log from './views/Logs/Log.js';
    ...
    async handleLocationChange() {
        ...
        switch (this.router.params.page) {
            ...
            case 'log-overview':
                ...
                break;
            case 'log-detail':
                this.logs.fetchLogById(this.router.params.id);
                this.logs.infiniteScrollEnabled = false;
                break;
            case 'log-create':
                this.log.setMarkdownBox('text', { location: 'log', name: 'setText' });
                this.tags.fetchAllTags();
                break;
            case 'run-overview':
                // Prevent loading extra rows when it's not necessary
