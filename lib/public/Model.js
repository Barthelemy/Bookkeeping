...
import Run from './views/Runs/Run.js';
            ...
            case 'run-detail':
                if (this.router.params.panel) {
                    ...
                    switch (this.router.params.panel) {
                        case 'logs':
                            await this.run.fetchLogsOfRun(this.router.params.id);
                            break;
                        case 'flps':
                            await this.run.fetchFlpsOfRun(this.router.params.id);
                            break;
                        default:
                            break;
                    }
