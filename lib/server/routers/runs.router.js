    ...
    children: [
        ...
        },
        {
            ...
            children: [
                {
                    method: 'get',
                    controller: RunsController.getRunByRunNumber,
                },
                {
                    method: 'post',
                ...
                },
                {
                    method: 'get',
                    path: 'logs',
                    controller: RunsController.getLogsByRunNumber,
                },
                {
                    method: 'get',
                    path: 'flps',
                    controller: RunsController.getFlpsByRunNumber,
                },
            ],
        },
        {
        ...
        },
        {
            method: 'get',
            path: 'tags',
            controller: RunsController.listTagsByRunNumber,
        },
        {
            path: ':runId',
            method: 'patch',
